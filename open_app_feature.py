""" Ce module est utilisé pour lancer une application particulière sur un système, mais seules les applications dont le chemin est défini dans application_list.txt peuvent être ouvertes."""
import os
...
def open_app(app_name):
    os.chdir('D:\\Python\\Intelligent-Personnel-Assistance\\J.A.R.V.I.S\\important records')
